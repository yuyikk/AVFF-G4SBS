...
namespace G4SBS { 
  ...
  // kinematic type 
  enum Kine_t   { kElastic, kFlat, kInelastic, kDIS, kBeam, kSIDIS, kGun, kWiser, kPYTHIA6, kSIMC, kGMnElasticCheck, kCosmics, kPionPhoto, kAVFFGen, kAVFFGen_BOT, kAVFFGun};
  // experiment type
  // enum Exp_t    { kGEp, kNeutronExp, kSIDISExp, kC16, kA1n, kTDIS, kNDVCS, kGEnRP, kGEMHCtest};
  enum Exp_t    {kGEp, kGMN, kGEN, kSIDISExp, kC16, kA1n, kTDIS, kNDVCS, kGEnRP, kGEMHCtest, kGEPpositron, kWAPP, kGEp_BB, kALL, kAxialFF};
  ...
  enum SDet_t   { kGEM, kCAL, kRICH, kECAL, kBD, kIC, kTarget_GEn_Glass, kTarget_GEn_Al, kTarget_GEn_Cu, kTarget_GEn_3He, kAVFF_Virtual, kAVFF_TOF, kAVFF_NCal}; 
