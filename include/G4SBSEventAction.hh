...
public:
  ...
  void FillNeuArmVirtualData(G4SBSNeuArmVirtualHitsCollection *, G4SBSNeuArmVirtualoutput &);
  void FillNeuArmTOFData(G4SBSNeuArmTOFHitsCollection *, G4SBSNeuArmTOFoutput &);
  void FillNCalData(const G4Event *, G4SBSCalHitsCollection *, G4SBSNCALoutput &, G4SBSSDTrackOutput &);
