...
public:
  ...
  void SetNeuArmVirtualData(G4String, G4SBSNeuArmVirtualoutput);
  void SetNeuArmTOFData(G4String, G4SBSNeuArmTOFoutput);
  void SetNCalData(G4String, G4SBSNCALoutput);
  // for D Flay studies
  ...
  void BranchNeuArmTOF(G4String s); // for neutron arm TOF
  void BranchNeuArmVirtual(G4String s);// for neutron arm virtual planes
...
private:
  ...
  map<G4String, G4SBSNeuArmVirtualoutput> NeuArmVirtualData;
  map<G4String, G4SBSNeuArmTOFoutput> NeuArmTOFData;
  map<G4String, G4SBSNCALoutput> NCalData;
