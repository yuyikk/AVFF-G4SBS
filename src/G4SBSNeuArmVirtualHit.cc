...
G4Allocator<G4SBSNeuArmVirtualHit> G4SBSNeuArmVirtualHitAllocator;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4SBSNeuArmVirtualHit::G4SBSNeuArmVirtualHit() : G4VHit()
{
    Clear();
}
...
G4SBSNeuArmVirtualHit::~G4SBSNeuArmVirtualHit()
{
    //
}
...
// bool G4SBSNeuArmVirtualHit::operator ==(const G4SBSNeuArmVirtualHit &right) const
// {
...
void G4SBSNeuArmVirtualHit::Print()
{
...
void G4SBSNeuArmVirtualHit::Clear()
{
    fPID = 0;
    fTrackID = 0;
    fPTrackID = 0;
